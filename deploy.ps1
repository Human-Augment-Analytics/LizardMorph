...
function Test-Predictor {
    if (-not (Test-Path "backend/new_landmarks_2025_predictor.dat")) {
        Write-Host "ERROR: The predictor file 'backend/new_landmarks_2025_predictor.dat' is missing!" -ForegroundColor $RED
